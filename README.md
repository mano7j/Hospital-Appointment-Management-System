...
- Implementing backend logic using Python and Flask framework  
- Developing responsive user interfaces using HTML, CSS, and JavaScript  
- Handling data flow between client and server  
- Working collaboratively in a team with defined roles  
- Debugging and resolving integration issues  

This project helped us strengthen both our technical skills and our ability to work effectively as a team.
